...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <input value="<?= $i->tanggal_pemesanan?>" required class="form-control" type="date" name="tanggal_pemesanan" id="">
            <label for="">JAM PEMESANAN</label>
            <input value="<?= $i->jam_pemesanan?>" required class="form-control" type="time" name="jam_pemesanan" id="">
        </div>
            <?php 
            endforeach;
            ?>
